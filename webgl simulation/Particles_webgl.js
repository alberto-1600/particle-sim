import { Vector2d, VectorPolar } from "./Vectors_webgl.js";
import { VectorMath as VM } from "./Vectors_webgl.js";
...
export class Particle{
    ...
    update_position(dt){
        ...
        this.vel.x1 += this.acc.x1 * dt;
        this.vel.y1 += this.acc.y1 * dt;

        this.pos.x1 += this.vel.x1 * dt;
    ...
    boundary_collision(){
        ...
        // X
        if(this.pos.x1+this.r > 600){
            this.pos.x1 = 600-this.r
            this.vel.x1 *= -1
        }
        ...
        // Y
        if(this.pos.y1+this.r > 600){
            this.pos.y1 = 600-this.r
            this.vel.y1 *= -1
        }
